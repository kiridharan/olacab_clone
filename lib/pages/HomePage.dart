            ...
            child:Column(
                ...
                children: [
                                          ...
                                          Row(
                                            ...
                                            children: [
                                              ...
                                              const Align(
                                                ...
                                                child: Image(
                                                  image: svgimage.Svg("lib/images/tag.svg"),
                                                  color: Colors.white,
                                                ), )
                                          ...
                                          children: [
                                            Padding(padding: const EdgeInsets.all(20),
                                              child:Column(
                                                  ...
                                                  Container(
                                                        margin:  EdgeInsets.only(bottom: 0,left: MediaQuery.of(context).size.width *.42),
                                                        child: Row(
                                                          mainAxisAlignment: MainAxisAlignment.center,
                                                          crossAxisAlignment: CrossAxisAlignment.end,
                                                          children: const [
                                            ...
                                            ClipRRect(
                                              ...
                                              child: Image(
                                                image: const AssetImage("lib/images/openjpg.jpg"),
                                                fit: BoxFit.cover,
                       ...
                       // crossAxisAlignment: CrossAxisAlignment.center,
                        ...
                        children: [
                            ...
                            child:  SizedBox(
                              ...
                              Padding(padding: EdgeInsets.all(10),
                                child: Align(
                                  ...
                                  child:  Image(
                                    image: svgimage.Svg("lib/images/lam.svg"),
                                    fit: BoxFit.fitWidth,
                                    width: 90,
                                    height: 80,
                                  ),
                          ...
                          Align(
                            ...
                            child: Card(
                              margin:  EdgeInsets.only(bottom: MediaQuery.of(context).size.height*0.11),
                              elevation: 1,
                              shape: RoundedRectangleBorder( borderRadius: BorderRadius.circular(25)),
                              color:  const Color.fromARGB(225, 6, 90, 51),
                              child:  SizedBox(
                            ...
                            children:const [
                              ...
                              Padding(padding: EdgeInsets.all(5),
                                child: Align(
                                  alignment: Alignment.centerRight,
                                  child:  Image(
                                    image: svgimage.Svg("lib/images/Package.svg"),
                                    fit: BoxFit.cover,
                                    width: 50,
                                    height: 60,
                                    ),
                  ...
                  Row(
                    ...
                    children: [
                      Card(
                        margin: const EdgeInsets.only(left: 5,right: 0,bottom: 15,top:5),
                        elevation: 1,
                        shape: RoundedRectangleBorder( borderRadius: BorderRadius.circular(25)),
                        color:  const Color.fromARGB(225, 219, 219, 219),
                        child: SizedBox(
                          ...
                          child:  Column(
                            ...
                            children: const [
                              Padding(padding: EdgeInsets.all(0),
                                child:  Image(image: svgimage.Svg("lib/images/lam.svg"),
                                  fit: BoxFit.fitWidth,
                                  width: 90,
                                  height: 70,) ,
                              ),
                        ...
                        child: SizedBox(
                          ...
                          child:  Column(
                            ...
                            children: const [
                              ...
                              Padding(padding: EdgeInsets.only(bottom:5),
                                child:   Text("Intercity",style: TextStyle(
                                    color: Colors.black
                                ),
                                ),
                              )
                    ...
                    children: [
                      Row(
                        ...
                        children: [
                          ...
                          const Text("Set destination on Map",)
                        ],
                      ),
                      const Icon(Icons.arrow_forward_ios,size: 16,)
                    ],
